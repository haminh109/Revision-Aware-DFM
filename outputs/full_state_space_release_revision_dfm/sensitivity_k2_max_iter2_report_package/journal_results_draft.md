...
Generated UTC: `2026-04-26T11:05:21+00:00`

Source output directory: `/Users/haaminh109/Desktop/Minh/Tài liệu học tập (DSEB)/Kì 6/Time Series/RADFM/paper_project/outputs/full_state_space_release_revision_dfm/sensitivity_k2_max_iter2`

Report package directory: `/Users/haaminh109/Desktop/Minh/Tài liệu học tập (DSEB)/Kì 6/Time Series/RADFM/paper_project/outputs/full_state_space_release_revision_dfm/sensitivity_k2_max_iter2_report_package`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_advance | A | 0.000 | 2.000 | 0.088 | 0.444 |
| point | revision_dfm_kalman_em | exact | pre_advance | A | 0.000 | 2.000 | 0.133 | 0.471 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_second | S | 0.000 | 2.000 | 0.088 | 0.420 |
| point | revision_dfm_kalman_em | exact | pre_second | S | 0.000 | 2.000 | 0.134 | 0.389 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_third | T | 0.000 | 2.000 | 0.088 | 0.234 |
| point | revision_dfm_kalman_em | exact | pre_third | T | 0.000 | 2.000 | 0.133 | 0.222 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_advance | A | 0.000 | 2.000 | 0.088 | 0.440 |
| point | revision_dfm_kalman_em | pseudo | pre_advance | A | 0.000 | 2.000 | 0.133 | 0.445 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_second | S | 0.000 | 2.000 | 0.088 | 0.420 |
| point | revision_dfm_kalman_em | pseudo | pre_second | S | 0.000 | 2.000 | 0.134 | 0.389 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_third | T | 0.000 | 2.000 | 0.088 | 0.236 |
| point | revision_dfm_kalman_em | pseudo | pre_third | T | 0.000 | 2.000 | 0.133 | 0.224 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| exact | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.444 | 0.366 | -0.003 | 4 |
| exact | pre_second | S | bridge | 0.159 | 0.118 | -0.090 | 4 |
| exact | pre_third | T | release_dfm | 0.066 | 0.042 | -0.028 | 4 |
| pseudo | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.440 | 0.362 | -0.028 | 4 |
| pseudo | pre_second | S | no_revision | 0.185 | 0.139 | 0.032 | 4 |
| pseudo | pre_third | T | release_dfm | 0.066 | 0.042 | -0.029 | 4 |
...
| indicator_revision_only_dfm_kalman_em | pre_advance | A | 0.483 | 0.483 | -0.000 |
| indicator_revision_only_dfm_kalman_em | pre_second | S | 0.328 | 0.329 | -0.000 |
| indicator_revision_only_dfm_kalman_em | pre_third | T | 0.222 | 0.223 | -0.001 |
| joint_indicator_revision_dfm_full_kalman_em | pre_advance | A | 0.444 | 0.440 | 0.004 |
| joint_indicator_revision_dfm_full_kalman_em | pre_second | S | 0.420 | 0.420 | -0.000 |
| joint_indicator_revision_dfm_full_kalman_em | pre_third | T | 0.234 | 0.236 | -0.002 |
...
| monthly_mixed_frequency_kalman_em | pre_advance | A | 0.457 | 0.468 | -0.011 |
| monthly_mixed_frequency_kalman_em | pre_second | S | 0.368 | 0.366 | 0.002 |
| monthly_mixed_frequency_kalman_em | pre_third | T | 0.351 | 0.349 | 0.001 |
...
| release_dfm | pre_advance | A | 0.518 | 0.506 | 0.013 |
| release_dfm | pre_second | S | 0.251 | 0.252 | -0.001 |
| release_dfm | pre_third | T | 0.066 | 0.066 | 0.000 |
| revision_dfm_kalman_em | pre_advance | A | 0.471 | 0.445 | 0.026 |
| revision_dfm_kalman_em | pre_second | S | 0.389 | 0.389 | 0.000 |
| revision_dfm_kalman_em | pre_third | T | 0.222 | 0.224 | -0.003 |
| spf | pre_advance | A | 0.703 | 0.703 | 0.000 |
| spf | pre_second | S | 0.825 | 0.825 | 0.000 |
| spf | pre_third | T | 0.891 | 0.891 | 0.000 |
| standard_dfm | pre_advance | A | 0.518 | 0.506 | 0.013 |
| standard_dfm | pre_second | S | 0.377 | 0.390 | -0.013 |
| standard_dfm | pre_third | T | 0.524 | 0.480 | 0.044 |
...
| joint_indicator_revision_dfm_full_kalman_em | pre_advance | DELTA_SA | 0.319 | 0.316 | 0.002 |
| joint_indicator_revision_dfm_full_kalman_em | pre_second | DELTA_TS | 0.154 | 0.154 | 0.000 |
| joint_indicator_revision_dfm_full_kalman_em | pre_third | DELTA_MT | 0.580 | 0.580 | -0.000 |
...
| monthly_mixed_frequency_kalman_em | pre_advance | DELTA_SA | 0.242 | 0.242 | 0.000 |
| monthly_mixed_frequency_kalman_em | pre_second | DELTA_TS | 0.151 | 0.151 | -0.000 |
| monthly_mixed_frequency_kalman_em | pre_third | DELTA_MT | 0.598 | 0.596 | 0.002 |
...
| release_dfm | pre_advance | DELTA_SA | 0.230 | 0.230 | 0.000 |
| release_dfm | pre_second | DELTA_TS | 0.118 | 0.118 | -0.000 |
| release_dfm | pre_third | DELTA_MT | 0.743 | 0.742 | 0.002 |
| revision_dfm_kalman_em | pre_advance | DELTA_SA | 0.316 | 0.314 | 0.003 |
...
| standard_dfm | pre_advance | DELTA_SA | 0.230 | 0.230 | 0.000 |
| standard_dfm | pre_second | DELTA_TS | 0.100 | 0.100 | -0.000 |
| standard_dfm | pre_third | DELTA_MT | 0.720 | 0.719 | 0.000 |

## Robustness Winners

| subsample | timing_mode | checkpoint_id | target_id | best_models | best_RMSE | best_n_forecasts |
| --- | --- | --- | --- | --- | --- | --- |
| full_sample | exact | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.444 | 4 |
| full_sample | exact | pre_second | S | bridge | 0.159 | 4 |
| full_sample | exact | pre_third | T | release_dfm | 0.066 | 4 |
| full_sample | pseudo | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.440 | 4 |
| full_sample | pseudo | pre_second | S | no_revision | 0.185 | 4 |
| full_sample | pseudo | pre_third | T | release_dfm | 0.066 | 4 |
| exclude_pandemic | exact | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.444 | 4 |
| exclude_pandemic | exact | pre_second | S | bridge | 0.159 | 4 |
| exclude_pandemic | exact | pre_third | T | release_dfm | 0.066 | 4 |
| exclude_pandemic | pseudo | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.440 | 4 |
| exclude_pandemic | pseudo | pre_second | S | no_revision | 0.185 | 4 |
| exclude_pandemic | pseudo | pre_third | T | release_dfm | 0.066 | 4 |
| post_pandemic | exact | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.444 | 4 |
| post_pandemic | exact | pre_second | S | bridge | 0.159 | 4 |
| post_pandemic | exact | pre_third | T | release_dfm | 0.066 | 4 |
| post_pandemic | pseudo | pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.440 | 4 |
| post_pandemic | pseudo | pre_second | S | no_revision | 0.185 | 4 |
| post_pandemic | pseudo | pre_third | T | release_dfm | 0.066 | 4 |
...
| --- | --- | --- | --- | --- |
| pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.444 | 4 |
| pre_second | S | bridge | 0.159 | 4 |
| pre_third | T | release_dfm | 0.066 | 4 |

Pseudo headline winners:

| checkpoint_id | target_id | best_models | best_RMSE | best_n_forecasts |
| --- | --- | --- | --- | --- |
| pre_advance | A | joint_indicator_revision_dfm_full_kalman_em | 0.440 | 4 |
