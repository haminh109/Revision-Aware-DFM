...
Generated UTC: `2026-04-26T11:04:05+00:00`

Source output directory: `/Users/haaminh109/Desktop/Minh/Tài liệu học tập (DSEB)/Kì 6/Time Series/RADFM/paper_project/outputs/full_state_space_release_revision_dfm/exact_pseudo_backtest_mature_1y_max_iter2`

Report package directory: `/Users/haaminh109/Desktop/Minh/Tài liệu học tập (DSEB)/Kì 6/Time Series/RADFM/paper_project/outputs/full_state_space_release_revision_dfm/exact_pseudo_backtest_mature_1y_max_iter2_report_package`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_advance | A | 0.000 | 2.000 | 0.081 | 0.585 |
| point | revision_dfm_kalman_em | exact | pre_advance | A | 0.000 | 2.000 | 0.128 | 0.577 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_second | S | 0.000 | 2.000 | 0.079 | 0.427 |
| point | revision_dfm_kalman_em | exact | pre_second | S | 0.000 | 2.000 | 0.129 | 0.405 |
| point | joint_indicator_revision_dfm_full_kalman_em | exact | pre_third | T | 0.000 | 2.000 | 0.080 | 0.236 |
| point | revision_dfm_kalman_em | exact | pre_third | T | 0.000 | 2.000 | 0.126 | 0.223 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_advance | A | 0.000 | 2.000 | 0.081 | 0.573 |
| point | revision_dfm_kalman_em | pseudo | pre_advance | A | 0.000 | 2.000 | 0.128 | 0.564 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_second | S | 0.000 | 2.000 | 0.079 | 0.427 |
| point | revision_dfm_kalman_em | pseudo | pre_second | S | 0.000 | 2.000 | 0.129 | 0.404 |
| point | joint_indicator_revision_dfm_full_kalman_em | pseudo | pre_third | T | 0.000 | 2.000 | 0.080 | 0.238 |
| point | revision_dfm_kalman_em | pseudo | pre_third | T | 0.000 | 2.000 | 0.126 | 0.225 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| exact | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.409 | 0.392 | 0.006 | 4 |
| exact | pre_second | S | bridge | 0.159 | 0.118 | -0.090 | 4 |
| exact | pre_third | T | release_dfm | 0.076 | 0.054 | -0.037 | 4 |
| pseudo | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.421 | 0.411 | -0.016 | 4 |
...
| exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 0.228 | 0.125 | 0.000 | 4 |
...
| pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 0.228 | 0.125 | 0.000 | 4 |
...
| indicator_revision_only_dfm_kalman_em | pre_advance | A | 0.600 | 0.596 | 0.004 |
| indicator_revision_only_dfm_kalman_em | pre_second | S | 0.321 | 0.321 | 0.000 |
| indicator_revision_only_dfm_kalman_em | pre_third | T | 0.212 | 0.213 | -0.001 |
| joint_indicator_revision_dfm_full_kalman_em | pre_advance | A | 0.585 | 0.573 | 0.012 |
| joint_indicator_revision_dfm_full_kalman_em | pre_second | S | 0.427 | 0.427 | 0.000 |
| joint_indicator_revision_dfm_full_kalman_em | pre_third | T | 0.236 | 0.238 | -0.001 |
...
| monthly_mixed_frequency_kalman_em | pre_advance | A | 0.409 | 0.421 | -0.012 |
| monthly_mixed_frequency_kalman_em | pre_second | S | 0.431 | 0.429 | 0.002 |
| monthly_mixed_frequency_kalman_em | pre_third | T | 0.284 | 0.282 | 0.002 |
...
| revision_dfm_kalman_em | pre_advance | A | 0.577 | 0.564 | 0.013 |
| revision_dfm_kalman_em | pre_second | S | 0.405 | 0.404 | 0.001 |
| revision_dfm_kalman_em | pre_third | T | 0.223 | 0.225 | -0.002 |
...
| indicator_revision_only_dfm_kalman_em | pre_third | DELTA_MT | 0.326 | 0.326 | 0.000 |
| joint_indicator_revision_dfm_full_kalman_em | pre_advance | DELTA_SA | 0.268 | 0.264 | 0.005 |
| joint_indicator_revision_dfm_full_kalman_em | pre_second | DELTA_TS | 0.154 | 0.154 | 0.000 |
| joint_indicator_revision_dfm_full_kalman_em | pre_third | DELTA_MT | 0.337 | 0.337 | -0.000 |
| midas_umidas | pre_advance | DELTA_SA | 0.680 | 0.681 | -0.001 |
| midas_umidas | pre_second | DELTA_TS | 0.471 | 0.481 | -0.010 |
| midas_umidas | pre_third | DELTA_MT | 2.243 | 2.214 | 0.030 |
| monthly_mixed_frequency_kalman_em | pre_advance | DELTA_SA | 0.219 | 0.219 | 0.000 |
| monthly_mixed_frequency_kalman_em | pre_second | DELTA_TS | 0.156 | 0.156 | -0.001 |
| monthly_mixed_frequency_kalman_em | pre_third | DELTA_MT | 0.344 | 0.343 | 0.001 |
| no_revision | pre_advance | DELTA_SA | 0.185 | 0.185 | 0.000 |
| no_revision | pre_second | DELTA_TS | 0.154 | 0.154 | 0.000 |
| no_revision | pre_third | DELTA_MT | 0.326 | 0.326 | 0.000 |
| release_dfm | pre_advance | DELTA_SA | 0.222 | 0.222 | -0.000 |
| release_dfm | pre_second | DELTA_TS | 0.113 | 0.113 | 0.000 |
| release_dfm | pre_third | DELTA_MT | 0.387 | 0.387 | 0.000 |
| revision_dfm_kalman_em | pre_advance | DELTA_SA | 0.270 | 0.265 | 0.005 |
| revision_dfm_kalman_em | pre_second | DELTA_TS | 0.154 | 0.154 | -0.000 |
| revision_dfm_kalman_em | pre_third | DELTA_MT | 0.339 | 0.339 | -0.000 |
| spf | pre_advance | DELTA_SA | 0.185 | 0.185 | 0.000 |
| spf | pre_second | DELTA_TS | 0.154 | 0.154 | 0.000 |
| spf | pre_third | DELTA_MT | 0.326 | 0.326 | 0.000 |
| standard_dfm | pre_advance | DELTA_SA | 0.222 | 0.222 | -0.000 |
| standard_dfm | pre_second | DELTA_TS | 0.102 | 0.103 | -0.000 |
| standard_dfm | pre_third | DELTA_MT | 0.401 | 0.402 | -0.001 |

## Robustness Winners

| subsample | timing_mode | checkpoint_id | target_id | best_models | best_RMSE | best_n_forecasts |
| --- | --- | --- | --- | --- | --- | --- |
| full_sample | exact | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.409 | 4 |
| full_sample | exact | pre_second | S | bridge | 0.159 | 4 |
| full_sample | exact | pre_third | T | release_dfm | 0.076 | 4 |
| full_sample | pseudo | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.421 | 4 |
| full_sample | pseudo | pre_second | S | no_revision | 0.185 | 4 |
| full_sample | pseudo | pre_third | T | release_dfm | 0.076 | 4 |
| exclude_pandemic | exact | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.409 | 4 |
| exclude_pandemic | exact | pre_second | S | bridge | 0.159 | 4 |
| exclude_pandemic | exact | pre_third | T | release_dfm | 0.076 | 4 |
| exclude_pandemic | pseudo | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.421 | 4 |
| exclude_pandemic | pseudo | pre_second | S | no_revision | 0.185 | 4 |
| exclude_pandemic | pseudo | pre_third | T | release_dfm | 0.076 | 4 |
| post_pandemic | exact | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.409 | 4 |
| post_pandemic | exact | pre_second | S | bridge | 0.159 | 4 |
| post_pandemic | exact | pre_third | T | release_dfm | 0.076 | 4 |
| post_pandemic | pseudo | pre_advance | A | monthly_mixed_frequency_kalman_em | 0.421 | 4 |
...
| full_sample | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| full_sample | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| exclude_pandemic | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| exclude_pandemic | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| post_pandemic | exact | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| post_pandemic | pseudo | pre_third | DELTA_MT | no_revision; spf; indicator_revision_only_dfm_kalman_em | 0.326 | 4 |
...
| --- | --- | --- | --- | --- |
| pre_advance | A | monthly_mixed_frequency_kalman_em | 0.409 | 4 |
...
| checkpoint_id | target_id | best_models | best_RMSE | best_n_forecasts |
| --- | --- | --- | --- | --- |
| pre_advance | A | monthly_mixed_frequency_kalman_em | 0.421 | 4 |
