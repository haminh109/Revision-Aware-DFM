...
This folder is a standalone prototype for a full Kalman/EM version of the release-structured, revision-aware GDP nowcasting model.
...
- `exact_pseudo_backtest.py`: release-checkpoint backtest that compares AR, bridge, standard DFM, release DFM, revision DFM, and full joint Kalman/EM on the same exact/pseudo origins.
